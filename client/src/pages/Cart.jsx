    ...
    <div className="container mx-auto p-4 sm:p-6">
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-2/3">
          ...
          <button 
            onClick={clearCart} 
            className="mt-4 text-red-600 hover:text-red-800 font-medium text-sm flex items-center gap-1"
          >
            Isprazni korpu
          </button>
        </div>

        {/* Pregled narudžbe (Sidebar) */}
        <div className="lg:w-1/3">
          <div className="bg-white p-6 rounded-lg shadow top-24 sticky">
            ...
            <button className="w-full bg-green-600 text-white font-bold py-3 px-4 rounded-lg hover:bg-green-700 transition shadow-lg">
              Nastavi na plaćanje
            </button>
          </div>
        </div>
